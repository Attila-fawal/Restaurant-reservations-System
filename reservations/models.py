...
class Customer(models.Model):
    ...
    It has a one-to-one relationship with the User model from Django's auth module,
    and fields for name, phone number, and email.
    """
...
class Item(models.Model):
    ...
    It contains fields for the item's name, price, and the menu it belongs to.
    """
    name = models.CharField(max_length=50)
